...
const STATIC_CACHE = 'banplex-static-v11'; // <-- Versi dinaikkan
const DYNAMIC_CACHE = 'banplex-dynamic-v11';
const IMG_CACHE = 'banplex-img-v11';
const FONT_CACHE = 'banplex-font-v11';
